...
def read_pred_from_callback(fdir):
	...
	for j in range(num_samples):
		...
		for i in range(seq_length-1):
				preds = torch.from_numpy(ins[j,vocab_length*i:vocab_length*(i+1)])
...
fdir_ouput='/g/g92/tran71/tran71/script/output/'
fdir_input='/g/g92/tran71/tran71/script/input/'

vocab_file= 'vocab_train.txt'
fdir='/g/g92/tran71/tran71/script/'
